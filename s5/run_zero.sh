...
#prepare phones.txt and L.fst, phones.txt should be same as one which used in training AM
utils/prepare_lang_test.sh data/local/dict_nosp "<UNK>" data/local/lang_tmp_nosp data/lang_nosp
...
utils/mkgraph.sh data/lang_nosp_test_tgsmall exp/chain_rvb/tdnn1n_rvb_online exp/chain_rvb/tdnn1n_rvb_online/graph_tgsmall 
